...
const Input = ({inputType = "text", refInput }: IInput) => {
    ...
    return (
        <div className="flex flex-col justify-center relative">
            ...
            <input maxLength={inputType === "cpf" ? 14 : undefined} type={inputType} onChange={handleChange} onBlur={handleBlur} onFocus={handleFocus} ref={ref} className=" h-12 bg-slate-900/40 rounded-xl px-4 text-xl" id={inputType} />
        </div>
    );
}
